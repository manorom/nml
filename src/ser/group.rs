...
impl serde::ser::Serializer for GroupSerializer {
    ...
    type SerializeSeq = serde::ser::Impossible<NamelistGroup, Error>;

    type SerializeTuple = serde::ser::Impossible<NamelistGroup, Error>;

    type SerializeTupleStruct = serde::ser::Impossible<NamelistGroup, Error>;

    type SerializeTupleVariant = serde::ser::Impossible<NamelistGroup, Error>;

    type SerializeMap = Self;

    type SerializeStruct = Self;

    type SerializeStructVariant = serde::ser::Impossible<NamelistGroup, Error>;

    fn serialize_bool(self, _v: bool) -> Result<Self::Ok, Self::Error> {
        Err(Error::non_container_on_top_level())
    }
...
impl serde::ser::SerializeMap for GroupSerializer {
    ...
    fn end(self) -> Result<Self::Ok, Self::Error> {
        let group_name = self.group_name.ok_or(Error::unsupported_serialization())?;
